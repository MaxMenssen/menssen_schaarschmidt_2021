...
# Please note that the distribution of GPQ_sigma_k is right skewed. Hence the
# estimate GPQ_sigma <- mean(as.numeric(GPQ_sigma_k)) is positively biassed. 
# E.g. for the interval, that is presented in Table 5 of the paper, the
# mean(as.numeric(GPQ_sigma_k)) was 0.39887687 and 
# median(as.numeric(GPQ_sigma_k)) was 0.03150815
