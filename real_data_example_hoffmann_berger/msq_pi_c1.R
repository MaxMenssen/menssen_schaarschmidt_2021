#-------------------------------------------------------------------------------
#---------------------- MSQ following Satterthwaite 1941 -----------------------
#-------------------------------------------------------------------------------
...
pi_c1_msq <- function(histdat,
        ...
        ms_star_a <- ss_star_a/df["a"]
        ms_star_b <- ss_star_b/df["b"]
        ms_star_res <- ss_star_res/df["res"]
        
        #----------------------------------------------------------------------
        w_a <- 1+(1/I)
        w_b <- 1-(1/J)
        w_res <- 1-(1/I)-(1/I)-(1/(I*J))
        ...
        # the variance of the data var(y). Hence the approx. df 6.35427785 used for 
        # interval calculation differs from that used by Hoffman & Berger (df=6.96)
        
        #-----------------------------------------------------------------------
        
        # Prediction variance (var_y + var_y_mean)
